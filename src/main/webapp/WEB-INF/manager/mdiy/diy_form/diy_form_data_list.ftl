		        			...
		        			<#list list as form>
			           			...
			           			<!--<td class="text-center basicId">${form['Id']?default(0)}</td>-->
			            			...
			            			<td class="text-center">
                    					<a class="btn btn-xs red tooltips del-btn " data-toggle="tooltip" data-original-title="删除" data-url="${manager}/mdiy/diyForm/form/${form['fromID']?default(0)}/${form['Id']?default(0)}/delete.do">
